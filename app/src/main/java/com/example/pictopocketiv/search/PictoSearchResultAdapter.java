...
public class PictoSearchResultAdapter extends RecyclerView.Adapter<PictoSearchResultAdapter.ResultViewHolder> {

    /** View Holder class **/
    public class ResultViewHolder extends RecyclerView.ViewHolder {

        private final PictoSearchResultAdapter mAdapter;
        ...
        public ResultViewHolder(@NonNull View itemView, PictoSearchResultAdapter mAdapter) {
            super(itemView);
    ...
    private PictoSearchCategoryDialogFragment mDialogFragment;
    ...
    /** C **/
    public PictoSearchResultAdapter(LinkedList<ArasaacModel.Pictogram> pictos,
    ...
    private void setListenersUI(@NonNull ResultViewHolder holder, int position) {
        ...
        holder.mSave.setOnClickListener(view -> {
            ...
            // Dialog Listener
            PictoSearchCategoryDialogFragment.OnDialogListener onDialogListener =
                    new PictoSearchCategoryDialogFragment.OnDialogListener() {
            ...
            // Creates dialog
            mDialogFragment = new PictoSearchCategoryDialogFragment(onDialogListener);
